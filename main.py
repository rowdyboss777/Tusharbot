...
keyboard = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/ROWDYOFFICIALBOT"),
        ],
        [
...
image_urls = [
    "https://graph.org/file/a0ad628424f21ee2c40d5-9318e0185a59f79a08.jpg",
    "https://graph.org/file/a0ad628424f21ee2c40d5-9318e0185a59f79a08.jpg",
    "https://graph.org/file/a0ad628424f21ee2c40d5-9318e0185a59f79a08.jpg",
    "https://graph.org/file/a0ad628424f21ee2c40d5-9318e0185a59f79a08.jpg",
    "https://graph.org/file/a0ad628424f21ee2c40d5-9318e0185a59f79a08.jpg",
...
async def upload(bot: Client, m: Message):
    ...
    await m.reply_text(f"`✨𝗕𝗮𝘁𝗰𝗵 𝗦𝘂𝗺𝗺𝗮𝗿𝘆✨\n"
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
                       f"📛𝗜𝗻𝗱𝗲𝘅 𝗥𝗮𝗻𝗴𝗲 » ({raw_text} to {len(links)})\n"
                       f"📚𝗕𝗮𝘁𝗰𝗵 𝗡𝗮𝗺𝗲 » {b_name}\n"
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
                       f"✨𝗧𝘅𝘁 𝗦𝘂𝗺𝗺𝗮𝗿𝘆✨ : {len(links)}\n"
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
